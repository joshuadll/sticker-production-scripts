...
# Runs AI_Deepnest.jsx against a fixture .ai file that has named paths in a
...
SCRIPT="$REPO_ROOT/pipelines/AI_Deepnest.jsx"
...
strip_variable_lines() {
    grep -Ev "^\[pipeline\] (=== AI_Deepnest (start|done)|document:)"
}
